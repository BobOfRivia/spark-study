...
/**
  ...
  */
object stonepicker {
  val filePath = "d://stock-message" + System.currentTimeMillis() + ".txt"
  var errcount:Int = 0
  /**
    *
    * @param args
  ...
  def getStockDetail(): Unit ={
    val urlSample = "http://q.stock.sohu.com/hisHq?code=cn_%s&start=20171109&end=20180308&stat=1&order=D&period=d&callback=historySearchHandler&rt=jsonp&r=0.11224118720128917&0.238318188568853";
